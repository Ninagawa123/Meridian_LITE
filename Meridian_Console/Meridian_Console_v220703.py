...
# 2022.07.04 Meridian配列 "Meridim90_220703.xlsx"版 に対応
# https://github.com/Ninagawa123/Meridian_LITE/tree/main/Documents
...
#定数
TITLE_VERSION="Meridian_Console_v220703" #DPGのウィンドウタイトル兼バージョン表示
    ...
    while (True):
        ...
        with closing(sock):
            while True:
                ...
                if frame_sync_s > 29999:
                    frame_sync_s = -30000
                temp_int16[0] = frame_sync_s #下位8ビットにframe_sync_sカウントアップを格納
        ...
        # データを送信Meridim配列に格納
                ...
                message4="SKIP COUNT TsySKIP:"+\
                    ...
                    " PCf:"+str(loop_count)+" BOARDf:"+str(frame_sync_r_resv+30000)+" "+str(int(loop_count/now))+"Hz"
