...
/*
// +----------------------------------------------------------------------
// | func name : monitor_joypad(ushort *arr)
// +----------------------------------------------------------------------
// | function  : Display gamepad keys.
// | argument  : short, array[3]
// +----------------------------------------------------------------------
...
// +----------------------------------------------------------------------
// | func name : monitor_servo_error(const String &text, int num, bool monitor_servo_error)
// +----------------------------------------------------------------------
// | function  : Show servo error id.
// | argument1 : String. "L","R","C",etc
// | argument2 : int. servo id.
// | argument3 : bool. 0:off, 1:on
// +----------------------------------------------------------------------
...
// +----------------------------------------------------------------------
// | function  : 起動時にwifi接続前までのステータスをシリアルモニタに出力する.
// | return    : none.
// +----------------------------------------------------------------------
...
// +----------------------------------------------------------------------
// | function  : 起動時にwifi接続後のステータスをシリアルモニタに出力する.
// | return    : none.
// +----------------------------------------------------------------------
