...
システムの中核はMeridim配列というロボットの状態データをコンパクトに格納できる軽量で汎用的なデータ配列です.  
...
当リポジトリのスクリプトを使用することにより, 100Hzの更新頻度をもつデジタルツインのロボットを実現することができます.  
...
### PC側の設定  
PC側の設定をすることで, UnityやROSを使用したデジタルツインのデモを実行できます.  
下記のサイトより「Meridian consoleを実行する」以降をお試しください.  
[https://github.com/Ninagawa123/Meridian_core](https://github.com/Ninagawa123/Meridian_TWIN)  
